...
# Generated by qmake (2.01a) (Qt 4.8.6) on: Wed May 6 17:47:46 2015
# Project:  untitled.pro
# Template: app
# Command: /usr/local/bin/qmake -spec /usr/local/Cellar/qt/4.8.6/mkspecs/unsupported/macx-clang-libc++ CONFIG+=debug CONFIG+=x86_64 -o Makefile untitled.pro
#############################################################################
...
all: Makefile untitled.app/Contents/PkgInfo untitled.app/Contents/Resources/empty.lproj untitled.app/Contents/Info.plist $(TARGET)

$(TARGET): ui_mainwindow.h $(OBJECTS)  
	@$(CHK_DIR_EXISTS) untitled.app/Contents/MacOS/ || $(MKDIR) untitled.app/Contents/MacOS/ 
	$(LINK) $(LFLAGS) -o $(TARGET) $(OBJECTS) $(OBJCOMP) $(LIBS)

Makefile: untitled.pro  /usr/local/Cellar/qt/4.8.6/mkspecs/unsupported/macx-clang-libc++/qmake.conf /usr/local/Cellar/qt/4.8.6/mkspecs/common/unix.conf \
		/usr/local/Cellar/qt/4.8.6/mkspecs/common/mac.conf \
		/usr/local/Cellar/qt/4.8.6/mkspecs/common/gcc-base.conf \
		/usr/local/Cellar/qt/4.8.6/mkspecs/common/gcc-base-macx.conf \
		/usr/local/Cellar/qt/4.8.6/mkspecs/common/clang.conf \
	...
	$(QMAKE) -spec /usr/local/Cellar/qt/4.8.6/mkspecs/unsupported/macx-clang-libc++ CONFIG+=debug CONFIG+=x86_64 -o Makefile untitled.pro
...
untitled.app/Contents/PkgInfo: 
	@$(CHK_DIR_EXISTS) untitled.app/Contents || $(MKDIR) untitled.app/Contents 
	@$(DEL_FILE) untitled.app/Contents/PkgInfo
	@echo "APPL????" >untitled.app/Contents/PkgInfo
untitled.app/Contents/Resources/empty.lproj: 
	@$(CHK_DIR_EXISTS) untitled.app/Contents/Resources || $(MKDIR) untitled.app/Contents/Resources 
...
untitled.app/Contents/Info.plist: 
	...
	@sed -e "s,@SHORT_VERSION@,1.0,g" -e "s,@TYPEINFO@,????,g" -e "s,@ICON@,,g" -e "s,@EXECUTABLE@,untitled,g" -e "s,@TYPEINFO@,????,g" /usr/local/Cellar/qt/4.8.6/mkspecs/unsupported/macx-clang-libc++/Info.plist.app >untitled.app/Contents/Info.plist
dist: 
	@$(CHK_DIR_EXISTS) .tmp/untitled1.0.0 || $(MKDIR) .tmp/untitled1.0.0 
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/untitled1.0.0/ && $(COPY_FILE) --parents mainwindow.h dot.h .tmp/untitled1.0.0/ && $(COPY_FILE) --parents main.cpp mainwindow.cpp dot.cpp .tmp/untitled1.0.0/ && $(COPY_FILE) --parents mainwindow.ui .tmp/untitled1.0.0/ && (cd `dirname .tmp/untitled1.0.0` && $(TAR) untitled1.0.0.tar untitled1.0.0 && $(COMPRESS) untitled1.0.0.tar) && $(MOVE) `dirname .tmp/untitled1.0.0`/untitled1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/untitled1.0.0
...
dot.o: dot.cpp dot.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o dot.o dot.cpp
